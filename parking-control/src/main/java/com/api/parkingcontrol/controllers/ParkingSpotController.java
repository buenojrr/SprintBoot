...
public class ParkingSpotController {
  ...
  public ParkingSpotController(ParkingSpotService parkingSpotServie) {
    this.parkingSpotService = parkingSpotServie;
  }
  ...
  public ResponseEntity<Object> deleteParkingSpot(@PathVariable(value = "id") UUID id) {
    ...
    return ResponseEntity.status(HttpStatus.OK).body("Parking Spot deleted successfeully.");
  ...
  public ResponseEntity<Object> updateParkingSpot(@PathVariable(value = "id") UUID id,
    ...
    // Outra maneira de atualizar - ao inves de obter o optional, pode se obter uma
    // nova instancia de parking model e fazer a conversao usando o bean utils
